...
class NewArtistFormState extends State<NewArtistForm> {
  ...
  // Platform to asset image mapping for DSP icons (shared with edit_artist_form.dart)
  static const Map<String, String> platformAssetMap = {
          ...
          onPressed: () async {
            ...
            if (_formKey.currentState!.validate()) {
              ...
              try {
                ...
                //    'artist_creation_error', e.toString());
                if (mounted) {
                  _showErrorDialog(
                    context,
              ...
              child: TextFormField(
                ...
                onChanged: (value) async {
                  if (platform == 'Spotify' && value.isNotEmpty) {
                    final imageUrl = await _musicVerificationService.getSpotifyArtistImage(value);
                    if (!mounted) return;
                    setState(() {
  ...
  Future<bool> _verifyMusicPlatforms(String artistName) async {
    ...
    try {
      ...
      //await analyticsService.logError(
      //    'artist_verification_error', e.toString());
      return false;
    } finally {
        ...
        TextButton(
          onPressed: () async {
            ...
            if (_formKey.currentState!.validate()) {
              ...
              await api.createSongwriter(songwriterData);
              Navigator.of(context).pop(true);
            }
          },
          child: Text(
