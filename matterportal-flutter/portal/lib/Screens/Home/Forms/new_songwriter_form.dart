...
class NewSongwriterForm extends StatefulWidget {
  ...
  @override
  State<NewSongwriterForm> createState() => _NewSongwriterFormState();
}

class _NewSongwriterFormState extends State<NewSongwriterForm> {
  ...
  Future<void> _createSongwriter() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Error creating songwriter: $e')),
        );
      }
    } finally {
      if (mounted) {
