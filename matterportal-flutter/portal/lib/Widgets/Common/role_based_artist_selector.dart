...
class _RoleBasedArtistSelectorState extends State<RoleBasedArtistSelector> {
  ...
  Future<void> _searchArtists(String query) async {
    ...
    try {
      final results = await api.searchInCollection(widget.collection, query);
      setState(() {
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              ...
              title: Text('Select Roles for $artist',
            ...
            children: [
              ...
              if (widget.selectedArtistsWithRoles.isNotEmpty)
                Container(
                  ...
                  child: Column(
                    children: widget.selectedArtistsWithRoles.map((artist) {
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Wrap(
                            spacing: 4,
                            runSpacing: 4,
                            children: (artist['roles'] as List).map((role) {
                              return Chip(
                                label: Text(
                                  role,
                                  style: const TextStyle(
                          ...
                          trailing: Row(
                            ...
                            children: [
                              IconButton(
                                ...
                                onPressed: () =>
                                    _showRoleSelectionDialog(artist['name']),
                              ),
                              IconButton(
                                icon:
